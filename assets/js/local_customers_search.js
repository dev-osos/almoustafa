    ...
    function initLocalCustomersSearch() {
        ...
        function updateCustomersTable(customers, pagination) {
            ...
            customers.forEach(function(customer) {
                ...
                actionsHtml += '<li><button type="button" class="dropdown-item" onclick="showCollectPaymentModal(this)" data-customer-id="' + customer.id + '" data-customer-name="' + escapeHtml(customer.name) + '" data-customer-balance="' + customer.raw_balance + '" data-customer-balance-formatted="' + escapeHtml(customer.balance_formatted) + '"><i class="bi bi-cash-coin me-2"></i>تحصيل</button></li>';
