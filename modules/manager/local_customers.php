...
<script>
// AJAX Pagination - تنقل بين صفحات الجدول بدون إعادة تحميل
(function() {
    'use strict';
    var paginationNav = document.getElementById('customersPagination');
    ...
    paginationNav.addEventListener('click', function(e) {
        ...
        .then(function(html) {
            ...
            // استبدال الـ pagination
            var newPag = doc.getElementById('customersPagination');
            if (newPag && paginationNav) {
                paginationNav.innerHTML = newPag.innerHTML;
                paginationNav.style.display = newPag.style.display || '';
            }
    ...
    }, true); // capture phase لمنع ajax-navigation من الاعتراض

    // دعم زر الرجوع في المتصفح
    window.addEventListener('popstate', function() {
        // إعادة تحميل فقط لو نفس الصفحة بباراميتر p مختلف
        var params = new URLSearchParams(window.location.search);
        if (params.get('page') === 'local_customers') {
