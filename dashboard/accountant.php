...
// معالجة AJAX لتقرير المنتجات الراكدة
...
// معالجة AJAX سجل أسعار منتج لعميل معين
if ($page === 'production_tasks' &&
    $_SERVER['REQUEST_METHOD'] === 'GET' &&
    isset($_GET['action']) &&
    trim($_GET['action']) === 'get_customer_price_history') {
...
<?php endif; ?>
            ...
            <?php elseif ($page === 'company_supplies'): ?>
                <?php
                $modulePath = __DIR__ . '/../modules/accountant/company_supplies.php';
                if (file_exists($modulePath)) {
                    include $modulePath;
                } else {
